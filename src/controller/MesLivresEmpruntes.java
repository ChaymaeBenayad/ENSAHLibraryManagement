...
public class MesLivresEmpruntes implements Initializable {
	...
	/*****************************************************
	 * Affichage des livres empruntés par un seul étudiant
	 *****************************************************/
	private void consulterLivresEmpruntes() {
		try {
			DB.connect();
			// affichage de tous les données de la table livresempruntes en se basant sur
			// l'id de l'étudiant connecté
